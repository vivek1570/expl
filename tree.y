%{
    ...
    %token<node> CLASS ENDCLASS NEW DELETE SELF
    ...
    %type <node> FIELD FieldFunction NewStmt DeleteStmt 
    ...
    ClassDef        : Cname '{'DECL Fieldlists MethodDecl ENDDECL MethodDefns '}'
                        {
                         ...
                         ;
    Cname           : ID        {Cptr = CInstall($1->varname,NULL);}
...
*/
    ...
    Gdecl:{flabel=funclass;}TypeName GidList EOL;
